                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 14, alignItems: 'center' }}>
                              {r.modalidade && (
                                <span style={{
                                  ...
                                  background: '#0044CC10', color: '#0044CC',
                              ...
                              {r.ano_emenda && (
                                <span style={{
                                  ...
                                  background: '#f3f4f6', color: 'var(--site-text-secondary)',
                                  border: '1px solid var(--site-border)',
                                }}>
                                  <Calendar size={11} />
                                  {r.ano_emenda}
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 20px' }}>
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  color: r.valor ? '#059669' : 'var(--site-text-tertiary)',
                              ...
                              <div>
                                ...
                                <div style={{
                                  fontSize: '1.05rem', fontWeight: 700,
                                  color: r.valor_emenda ? '#7c3aed' : 'var(--site-text-tertiary)',
                                  fontFamily: 'var(--font-outfit)',
                                }}>
                              ...
                              {r.prestacao_contas ? (
                                isUrl(r.prestacao_contas) ? (
                                  ...
                                  <span style={{
                                    ...
                                    color: 'var(--site-text-secondary)', background: '#f3f4f6',
                                    border: '1px solid var(--site-border)',
                                  }}>
                                    <FileCheck size={14} />
                                    {r.prestacao_contas}
