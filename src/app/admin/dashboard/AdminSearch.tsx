...
const SEARCH_INDEX: SearchItem[] = [
  ...
  },
  {
    id: 'nav-categories',
    title: 'Categorias',
    description: 'Organizar conteúdo em categorias temáticas',
    keywords: ['categorias', 'tags', 'organizar', 'taxonomia', 'temas', 'classificação'],
    path: '/admin/dashboard/categories',
    breadcrumb: 'Dashboard › Categorias',
    icon: Tag,
    category: 'Navegação',
  },
  {
    id: 'nav-media',
    title: 'Mídia / Imagens',
    description: 'Gerenciar galeria de imagens e arquivos enviados',
    keywords: ['midia', 'imagens', 'fotos', 'galeria', 'upload', 'arquivos', 'storage', 'media', 'banco de imagens'],
    path: '/admin/dashboard/media',
    breadcrumb: 'Dashboard › Mídia',
    icon: ImageIcon,
    category: 'Navegação',
  },
  {
  ...
  },
  {
    ...
    description: 'Adicionar uma nova categoria para organizar conteúdo',
    keywords: ['nova categoria', 'criar categoria', 'adicionar categoria'],
    path: '/admin/dashboard/categories',
    breadcrumb: 'Dashboard › Categorias › Nova',
    icon: Plus,
    category: 'Ação Rápida',
  },
  {
    ...
    description: 'Enviar novas imagens ou arquivos para a galeria',
    keywords: ['upload', 'enviar', 'subir', 'carregar', 'arquivo', 'imagem'],
    path: '/admin/dashboard/media',
    breadcrumb: 'Dashboard › Mídia › Upload',
    icon: Upload,
    category: 'Ação Rápida',
  },
