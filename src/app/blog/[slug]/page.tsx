  ...
  return (
    <PublicLayout>
      ...
      <style>{`
        ...
        .social-share-btn[title*="WhatsApp"]:hover { background: #25D366 !important; border-color: #25D366 !important; }
        .social-share-btn[title*="LinkedIn"]:hover { background: #0077B5 !important; border-color: #0077B5 !important; }
        .social-share-btn[title*="Twitter"]:hover { background: #1d9bf0 !important; border-color: #1d9bf0 !important; }
      `}</style>
    </PublicLayout>
  );
}
